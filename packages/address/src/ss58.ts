...
if (import.meta.vitest) {
    ...
    // Alice's well-known SS58 address (generic prefix 42)
    const ALICE_SS58 = "5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY";

    // Alice's 32-byte sr25519 public key
    ...
    test("ss58Encode and ss58Decode round-trip at prefix 0", () => {
